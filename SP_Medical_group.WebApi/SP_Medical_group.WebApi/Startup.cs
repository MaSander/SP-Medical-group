...
namespace SP_Medical_group.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                opitions.DefaultAuthenticateScheme = "JwtBearer";
                opitions.DefaultChallengeScheme = "JwtBearer";
            }).AddJwtBearer("JwtBearer", opitions =>
            {
                opitions.TokenValidationParameters = new Microsoft.IdentityModel.Tokens.TokenValidationParameters
                {
                    ValidateIssuer = true,
